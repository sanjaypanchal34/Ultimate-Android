...
public class CommentModel implements Serializable {
    ...
    public static CommentModel fromJson(JSONObject object) {
        return new Gson().fromJson(object.toString(), CommentModel.class);
    }


    public static CommentModel fromString(String user) {
        return new Gson().fromJson(user, CommentModel.class);
    }

    public static String toString(CommentModel model) {
